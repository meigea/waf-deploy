...
yum install zlib-devel bzip2-devel openssl-devel ncurses-devel sqlite-devel readline-develtk-devel gdbm-devel db4-devel libpcap-devel xz-devel -y
...
&& yum -y groupinstall "Development tools" \ && ./configure --prefix=$PYTHON3_PATH
